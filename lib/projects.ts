...
export const projects: Project[] = [
  ...
  {
    id: "invoice-code-matching-tool",
    slug: "invoice-code-matching-tool",
    ...
    image: "/images/projects/invoice-code-matching-tool.png",
  ...
  },
  {
    ...
    tagline: "Daily retail sales forecasting + descriptive analytics",
    description:
    ...
    metrics: "Gradient Boosting: MAE $494, sMAPE 13.0% — 24% MAE reduction vs ARIMA",
    featured: false,
  },
  {
    id: "la-liga-ranking",
